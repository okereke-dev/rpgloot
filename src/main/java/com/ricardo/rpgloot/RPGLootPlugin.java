...
public class RPGLootPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new StructureLootListener(this, rarityService), this);
        getServer().getPluginManager().registerEvents(new ArmorListener(this, rarityService), this);
